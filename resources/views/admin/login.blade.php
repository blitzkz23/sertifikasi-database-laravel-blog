            ...
            <div class="card-body pl-4 pr-4">
                <div class="row">
                    <div class="col-lg-7 d-flex align-items-center">
                        <img src="assets/images/bg-login.jpg" alt="card-img-top">
                    </div>
                    ...
                    <div class="col-lg-5">
                        <form action="{{ url('login') }}" method="post" enctype="multipart/form-data">
                            ...
                            <p class="logincta mt-4 mb-3">Don't have an account? <a href="register"
                                    class="hover-underline-animation">Register</a></p>
