...
@section('content')
    <div class="single-post">
        <div class="image-wrapper"><img src="{{ asset($posts->thumbnail) }}" alt="Blog Image"></div>
    ...
    <div class="comments-area">
        ...
        @foreach ($data['comment'] as $comment)
            <div class="comment">
                <div class="author-image"><img src="{{ url('assets/images/author-2-150x150.jpg') }}"
                        alt="Autohr Image"></div>
